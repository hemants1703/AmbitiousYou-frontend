...
<main class="min-h-dvh flex flex-col w-full h-[calc(100vh-5.1rem)]">
	<Toasts />
	<div class="fixed left-0 right-0 top-0 w-full z-50">
	...
	<div class="fixed bottom-2 left-1/2 transform -translate-x-1/2 w-auto z-50">
		<AmbitiousDock />
	</div>
</main>
