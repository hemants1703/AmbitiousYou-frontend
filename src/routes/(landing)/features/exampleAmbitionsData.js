...
const exampleAmbitionsData = [
	{
		...
		ambitions: [
			{
				userId: 'u1',
				userEmail: 'entrepreneur1@example.com',
				ambitionName: 'Launch a Startup',
				ambitionDefinition:
					'Successfully start your own business, from idea inception to market entry.',
				ambitionType: 'Professional',
				ambitionStartDate: '2022-01-01',
				ambitionEndDate: '2023-10-01',
				ambitionCompletionDate: '2023-10-01',
			...
			},
			{
				userId: 'u1',
				userEmail: 'entrepreneur1@example.com',
				ambitionName: 'Scale the Business',
				ambitionDefinition:
					'Grow your startup by increasing revenue, expanding the customer base, and improving operations.',
				ambitionType: 'Professional',
				ambitionStartDate: '2023-11-01',
				ambitionEndDate: '2024-10-01',
				...
				ambitionTags: ['Scaling', 'Marketing'],
				ambitionNotes: [
					{
						id: 1,
						content:
			...
			},
			{
				userId: 'u1',
				userEmail: 'entrepreneur1@example.com',
				ambitionName: 'Build a Global Brand',
				ambitionDefinition:
					'Establish a brand recognized and respected across international markets.',
				ambitionType: 'Professional',
				ambitionStartDate: '2024-11-01',
				ambitionEndDate: '2026-12-31',
				ambitionCompletionDate: null,
				...
				ambitionTags: ['Global Expansion', 'Branding'],
				ambitionNotes: [
					{
						id: 1,
						content:
	...
	},
	{
		...
		ambitions: [
			{
				userId: 'u2',
				userEmail: 'freelancer1@example.com',
				ambitionName: 'Establish a Freelance Business',
				ambitionDefinition:
					'Set up your freelance operation, establish a client base, and deliver high-quality work.',
				ambitionType: 'Professional',
				ambitionStartDate: '2021-06-01',
				ambitionEndDate: '2022-05-31',
				ambitionCompletionDate: '2022-05-31',
				ambitionStatus: 'Completed',
				ambitionPriority: 'High',
				ambitionCategory: 'Business',
				percentageCompleted: 100,
				ambitionTasks: [
					...
					{
						id: 3,
						name: 'Deliver projects and gather testimonials',
						description: 'Deliver projects on time and gather testimonials for credibility.',
						checked: true
					}
				],
				ambitionTags: ['Freelancing', 'Portfolio', 'Client Acquisition'],
				ambitionNotes: [
					{
						id: 1,
						content:
							'The key to freelance success is to consistently deliver value and build long-term relationships.',
						created_at: '2022-05-31T10:30:00Z'
					}
				],
				$id: 'amb4',
				$createdAt: '2021-06-01T08:00:00Z',
				$updatedAt: '2022-05-31T15:00:00Z',
				$permissions: ['read', 'write'],
				$databaseId: 'db2',
				$collectionId: 'col4'
			},
			{
				userId: 'u2',
				userEmail: 'freelancer1@example.com',
				ambitionName: 'Diversify Income Streams',
				ambitionDefinition:
					'Create multiple revenue channels by offering different services or products.',
				ambitionType: 'Professional',
				ambitionStartDate: '2023-01-15',
				ambitionEndDate: '2024-12-31',
				ambitionCompletionDate: null,
				ambitionStatus: 'Ongoing',
				ambitionPriority: 'Medium',
				...
				ambitionTasks: [
					{
						id: 1,
						name: 'Learn complementary skills',
						description: 'Expand your offerings by learning complementary skills.',
						checked: true
					},
					{
					...
					{
						id: 3,
						name: 'Explore passive income opportunities',
						description:
							'Explore passive income opportunities like affiliate marketing or paid consultations.',
						checked: false
					}
				],
				ambitionTags: ['Income', 'Skills', 'Diversification'],
				ambitionNotes: [
					{
						id: 1,
						content:
			...
			},
			{
				userId: 'u2',
				userEmail: 'freelancer1@example.com',
				ambitionName: 'Build a Personal Brand',
				ambitionDefinition:
					'Become a recognized name in your niche, attracting clients without active outreach.',
				ambitionType: 'Professional',
				ambitionStartDate: '2024-01-01',
				ambitionEndDate: '2025-12-31',
				ambitionCompletionDate: null,
				ambitionStatus: 'Future',
				ambitionPriority: 'High',
				ambitionCategory: 'Branding',
				...
				ambitionTasks: [
					...
					},
					{
						...
						description: 'Grow your social media presence by providing value in your niche.',
						checked: false
					},
					{
						id: 3,
				...
				ambitionTags: ['Personal Branding', 'Social Media', 'Networking'],
				ambitionNotes: [
					{
						id: 1,
						content: 'Your personal brand is your greatest asset as a freelancer—nurture it.',
		...
		ambitions: [
			{
				...
				ambitionName: 'Learn a New Programming Language',
				ambitionDefinition:
					'Master a new programming language to stay relevant in the tech industry.',
				ambitionType: 'Professional',
				ambitionStartDate: '2022-02-01',
				ambitionEndDate: '2022-12-31',
				ambitionCompletionDate: '2022-12-31',
				ambitionStatus: 'Completed',
				ambitionPriority: 'High',
				...
				ambitionTags: ['Programming', 'Learning', 'Skills'],
				ambitionNotes: [
					{
						id: 1,
						content:
							'Learning a new language expands your problem-solving toolkit, which is critical in software development.',
						created_at: '2022-12-31T18:00:00Z'
					}
				],
				$id: 'amb7',
				$createdAt: '2022-02-01T12:00:00Z',
				$updatedAt: '2022-12-31T20:00:00Z',
				$permissions: ['read', 'write'],
				$databaseId: 'db3',
				$collectionId: 'col7'
			},
			{
				userId: 'u3',
				userEmail: 'developer1@example.com',
				ambitionName: 'Contribute to Open-Source Projects',
				ambitionDefinition:
					'Actively participate in open-source communities by contributing to popular repositories.',
				ambitionType: 'Professional',
				ambitionStartDate: '2023-03-01',
				ambitionEndDate: '2025-03-01',
				ambitionCompletionDate: null,
				ambitionStatus: 'Ongoing',
				ambitionPriority: 'Medium',
				...
				ambitionTasks: [
					...
					{
						id: 3,
						name: 'Attend open-source conferences',
						description:
							'Build relationships within the community and attend open-source conferences.',
						checked: false
					}
				],
				ambitionTags: ['Open Source', 'Collaboration', 'Community'],
				ambitionNotes: [
					{
						id: 1,
						content:
			...
			},
			{
				userId: 'u3',
				userEmail: 'developer1@example.com',
				ambitionName: 'Launch Your Own SaaS Product',
				ambitionDefinition:
					'Develop and launch a Software-as-a-Service (SaaS) product to generate recurring revenue.',
				ambitionType: 'Professional',
				ambitionStartDate: '2024-04-01',
				ambitionEndDate: '2026-06-01',
				ambitionCompletionDate: null,
				ambitionStatus: 'Future',
				ambitionPriority: 'High',
				...
				ambitionTasks: [
					...
					{
						id: 3,
						name: 'Set up marketing funnels',
						description: 'Set up marketing and customer acquisition funnels for launch.',
						checked: false
					}
				],
				ambitionTags: ['SaaS', 'Product', 'Tech'],
				ambitionNotes: [
					{
						id: 1,
						content:
							'SaaS is a long-term play—focus on customer retention and continuous iteration.',
		...
		ambitions: [
			{
				...
				ambitionName: 'Graduate with Honors',
				ambitionDefinition: 'Excel academically and graduate with distinction from your program.',
				ambitionType: 'Academic',
				ambitionStartDate: '2019-09-01',
				ambitionEndDate: '2023-06-30',
				ambitionCompletionDate: '2023-06-30',
				ambitionStatus: 'Completed',
				ambitionPriority: 'High',
				...
				ambitionTasks: [
					{
						id: 1,
						name: 'Maintain high GPA',
						description: 'Maintain a high GPA by focusing on major courses.',
						checked: true
					},
					{
						id: 2,
						name: 'Participate in academic projects',
						description: 'Participate in extracurricular academic projects and competitions.',
						checked: true
					},
					{
				...
				ambitionTags: ['Graduation', 'Honors', 'Academic'],
				ambitionNotes: [
					{
						id: 1,
						content:
			...
			},
			{
				userId: 'u4',
				userEmail: 'student1@example.com',
				ambitionName: 'Secure an Internship',
				ambitionDefinition:
					'Gain real-world experience by working in your field before graduation.',
				ambitionType: 'Career',
				ambitionStartDate: '2023-01-01',
				ambitionEndDate: '2024-06-01',
				ambitionCompletionDate: null,
				ambitionStatus: 'Ongoing',
				ambitionPriority: 'Medium',
				...
				ambitionTags: ['Internship', 'Career', 'Networking'],
				ambitionNotes: [
					{
						id: 1,
						content:
			...
			},
			{
				userId: 'u4',
				userEmail: 'student1@example.com',
				ambitionName: 'Land a Full-Time Job After Graduation',
				ambitionDefinition: 'Secure a job in your field of study upon graduation.',
				ambitionType: 'Career',
				ambitionStartDate: '2024-09-01',
				ambitionEndDate: '2025-06-30',
				ambitionCompletionDate: null,
				ambitionStatus: 'Future',
				ambitionPriority: 'High',
				...
				ambitionTags: ['Job Search', 'Career', 'Networking'],
				ambitionNotes: [
					{
						id: 1,
						content:
							'Your first job is just the beginning—focus on continuous learning and growth.',
